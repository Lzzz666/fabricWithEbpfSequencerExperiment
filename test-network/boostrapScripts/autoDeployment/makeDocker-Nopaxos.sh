...
###############################################################################
# Build Docker Images for NOPaxos
#
# 在所有 GCP VMs 上編譯 NOPaxos 版本的 Fabric Docker images
#
# 使用方法:
#   ./makeDocker-Nopaxos.sh
###############################################################################
...
# 專案路徑 (NOPaxos 版本)
FABRIC_REPO="~/Fabric_batch_unit_order"
GIT_BRANCH="origin/only_hash_for_block"
...
echo "=========================================="
echo " Build Docker Images - NOPaxos"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
log_success "NOPaxos Docker Images 編譯完成!"
echo "=========================================="
echo ""
echo "下一步:"
echo "  ./autoDeploymentGCP.sh"
echo ""
